        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-body">
                <form action="/update_supplierpersonal" method="post"  enctype="multipart/form-data">
                  <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                <div class="row">
                <div class="col-sm-12 col-md-6">
                <div class="dataTables_length" id="datatable_length">
                </div>
                <a href="/supplier_Report" class="btn btn-primary btn-sm"> Back</a> 
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 pr-md-1">
                      ...
                      <div class="form-group">
                         <label>Image </label>
                        <input type="file" name="file" value="${supplierEdit.image}" placeholder="" class="form-control" />
                      </div>
                    </div> 
