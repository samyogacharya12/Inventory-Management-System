...
<head>
    ...
    <!-- Nucleo Icons -->  <link href="static/black-dashboard-html-v1.0.1/assets/css/nucleo-icons.css" rel="stylesheet" />
    <!-- CSS Files -->
    ...
    <script type="text/javascript" src="static/RestJs/saveCustomer.js"> </script>
</head>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="customerPersonalForm" action="/save-customer" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 px-md-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="customerName"  name="customerName" placeholder="username" class="form-control" />
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 pl-md-1">
                                    <div class="form-group">
                                        ...
                                        <input type="Date" id="buyDate"  name="buyDate"  class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="card-footer">
                                    <div class="col-md-4">
                                        <button id="savePersonalCustomer" type="submit" class="btn btn-fill btn-primary">Save</button>
                                    </div>
                                </div>
                            </form>
                        </div>
