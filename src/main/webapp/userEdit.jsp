...
<body class="">
                ...
                <form action="/update_product" method="post" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-md-3 px-md-1">
                      <div class="form-group">
                        ...
                        <input type="text"  name="username" value="${userEdit.username}" placeholder="username" class="form-control" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 px-md-1">
                      <div class="form-group">
                        ...
                        <input type="password" name="password" value="${userEdit.password}" placeholder="password" class="form-control" />
                      </div>
                    </div>
                    </div>
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="email" name="email" value="${userEdit.email}" placeholder="mike@email.com" class="form-control"/>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                         <label>Country </label>
                        <input type="text" name="country" value="${userEdit.country}" placeholder="Country" class="form-control" />
                      </div>
                    </div>
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
  ...
  <option value="2" ${userEdit.user_role_id=='2'?'selected':''}>2</option>
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="form-group">
<input type="radio" name="gender" value="male" ${userEdit.gender=='male'?'checked':'' or userEdit.gender == null?'checked':''}/> Male
<input type="radio" name="gender" value="female" ${userEdit.gender=='female'?'checked':''}/> Female
  </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-8">
                      <div class="form-group">
                    <label> Upload Image </label> <input type="file" name="file" value="${userEdit.image}">
                    </div>
                    </div>
                    </div>
              ...
              <div class="card-footer">
               <div class="col-md-4">
                <button type="submit" class="btn btn-fill btn-primary" onclick="demo.showNotification('top','center')">Save</button>
              </div>
              </div>
