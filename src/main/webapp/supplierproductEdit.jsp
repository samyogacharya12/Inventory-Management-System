                ...
                <form action="/update_supplierproduct" method="post"  enctype="multipart/form-data" onsubmit="return validateForm()">
                 ...
                 <div class="col-md-4 px-md-1">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="quantity" value="${supplierproduct.quantity}" placeholder="" class="form-control"/>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        <label> Cost </label>
                        <input type="number"  name="cost" value="${supplierproduct.cost}" placeholder="" class="form-control" />
                      </div>
                    </div>
                    </div>          
