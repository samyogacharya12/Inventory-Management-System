...
<head>
	...
	<script type="text/javascript" src="static/RestJs/productAnalysisList.js"> </script>
	<script type="text/javascript" src="static/RestJs/gerProductAnalysisByName.js"> </script>
						...
						<div class="card-body">
							...
							<div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap4">
								<div class="row">
									...
									<div class="col-sm-12 col-md-6">
										<div id="datatable_filter" class="dataTables_filter">
											<form id="searchProductAnalysisForm" action="/getDataByName" method="get">
								...
								<div class="row"><div class="col-sm-12">
									<table id="productAnalysisList" class="table">
