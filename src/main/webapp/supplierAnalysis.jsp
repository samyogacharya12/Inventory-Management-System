...
<head>
    ...
    <script type="text/javascript" src="static/RestJs/supplierAnalysisList.js"> </script>
    <script type="text/javascript" src="static/RestJs/getSupplierAnalysisById.js"> </script>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div id="datatable_filter" class="dataTables_filter">
                                            <form id="searchSupplierAnalysisForm" action="/getSupplierAnalysisDataBySupplierId"  method="get">
                                                <label><input type="search" id="supplierIdSearch" name="supplierId" class="form-control form-control-sm" placeholder="Search records" aria-controls="datatable"></label>
                                                <button class="btn btn-primary btn-sm">Search</button>
                                            </form>
                                        </div></div></div>

                                <div class="row"><div class="col-sm-12">
                                    <table id="supplierAnalysisList" class="table">
                                        ...
                                        <tbody id="supplierAnalysisData">

                                        <tbody id="getSupplierByName">
